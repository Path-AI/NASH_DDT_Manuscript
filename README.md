...
- The final set of analysis is used for comparing accuracy of the AIM-NASH and the AI-assisted workflows to that of the manual pathologists. The run script for this analysis is: `run_cv_analysis_manuscript.py`
